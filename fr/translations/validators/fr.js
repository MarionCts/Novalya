...
t.add("property.name.not_blank", "* Ce champ ne peut pas \u00eatre vide", "validators", "fr");
t.add("property.name.length_min", "* Le champ doit contenir au moins {{ limit }} caract\u00e8res", "validators", "fr");
t.add("property.name.length_max", "* Le champ ne peut pas d\u00e9passer {{ limit }} caract\u00e8res", "validators", "fr");
t.add("property.price.not_blank", "* Ce champ ne peut pas \u00eatre vide", "validators", "fr");
t.add("property.price.number", "* Vous devez entrer un nombre", "validators", "fr");
t.add("property.price.positive", "* Vous devez entrer un nombre sup\u00e9rieur \u00e0 0", "validators", "fr");
t.add("property.description.not_blank", "* Ce champ ne peut pas \u00eatre vide", "validators", "fr");
t.add("property.description.length_min", "* Le champ doit contenir au moins {{ limit }} caract\u00e8res", "validators", "fr");
t.add("property.description.length_max", "* Le champ ne peut pas d\u00e9passer {{ limit }} caract\u00e8res", "validators", "fr");
t.add("property.city.not_blank", "* Ce champ ne peut pas \u00eatre vide", "validators", "fr");
t.add("property.city.length_min", "* Le champ doit contenir au moins {{ limit }} caract\u00e8res", "validators", "fr");
t.add("property.city.length_max", "* Le champ ne peut pas d\u00e9passer {{ limit }} caract\u00e8res", "validators", "fr");
t.add("property.mapUrl.not_blank", "* Ce champ ne peut pas \u00eatre vide", "validators", "fr");
t.add("property.mapUrl.valid", "* Veuillez entrer une URL valide", "validators", "fr");
t.add("property.roomsTotal.not_blank", "* Ce champ ne peut pas \u00eatre vide", "validators", "fr");
t.add("property.roomsTotal.number", "* Vous devez entrer un nombre", "validators", "fr");
t.add("property.roomsTotal.positive", "* Vous devez entrer un nombre sup\u00e9rieur \u00e0 0", "validators", "fr");
t.add("property.bedrooms.not_blank", "* Ce champ ne peut pas \u00eatre vide", "validators", "fr");
t.add("property.bedrooms.number", "* Vous devez entrer un nombre", "validators", "fr");
t.add("property.bedrooms.positive", "* Vous devez entrer un nombre sup\u00e9rieur \u00e0 0", "validators", "fr");
t.add("property.bathrooms.not_blank", "* Ce champ ne peut pas \u00eatre vide", "validators", "fr");
t.add("property.bathrooms.number", "* Vous devez entrer un nombre", "validators", "fr");
t.add("property.bathrooms.positive", "* Vous devez entrer un nombre sup\u00e9rieur \u00e0 0", "validators", "fr");
t.add("property.indoorSurface.not_blank", "* Ce champ ne peut pas \u00eatre vide", "validators", "fr");
t.add("property.indoorSurface.number", "* Vous devez entrer un nombre", "validators", "fr");
t.add("property.indoorSurface.positive", "* Vous devez entrer un nombre sup\u00e9rieur \u00e0 0", "validators", "fr");
t.add("property.outdoorSurface.not_blank", "* Ce champ ne peut pas \u00eatre vide", "validators", "fr");
t.add("property.outdoorSurface.number", "* Vous devez entrer un nombre", "validators", "fr");
t.add("property.images.maxSizeMessage", "L'image ne peut pas d\u00e9passer {{ limit }} Mo", "validators", "fr");
t.add("property.images.mimeTypesMessage", "Veuillez choisir un fichier de format jpg, jpeg, png ou webp", "validators", "fr");
t.add("register.name.not_blank", "* Ce champ ne peut pas \u00eatre vide", "validators", "fr");
t.add("register.name.length_min", "* Le nom doit comporter un minimum de {{ limit }} caract\u00e8res", "validators", "fr");
t.add("register.name.length_max", "* Le nom ne peut pas d\u00e9passer {{ limit }} caract\u00e8res", "validators", "fr");
t.add("register.firstName.not_blank", "* Ce champ ne peut pas \u00eatre vide", "validators", "fr");
t.add("register.firstName.length_min", "* Le pr\u00e9nom doit comporter un minimum de {{ limit }} caract\u00e8res", "validators", "fr");
t.add("register.firstName.length_max", "* Le pr\u00e9nom ne peut pas d\u00e9passer {{ limit }} caract\u00e8res", "validators", "fr");
t.add("register.password.not_blank", "* Ce champ ne peut pas \u00eatre vide", "validators", "fr");
t.add("register.password.length_min", "* Le mot de passe doit comporter un minimum de {{ limit }} caract\u00e8res", "validators", "fr");
t.add("register.password.length_max", "* Le mot de passe ne peut pas d\u00e9passer {{ limit }} caract\u00e8res", "validators", "fr");
t.add("register.password.regex", "* Le mot de passe doit contenir au moins une lettre majuscule, une lettre minuscule et un caract\u00e8re sp\u00e9cial", "validators", "fr");
t.add("register.email.not_blank", "* Ce champ ne peut pas \u00eatre vide", "validators", "fr");
t.add("register.email.regex", "* L'adresse mail indiqu\u00e9e est invalide", "validators", "fr");
t.add("register.email.unique", "* Il existe d\u00e9j\u00e0 un compte avec cette adresse mail", "validators", "fr");
t.add("register.conditions.isFalse", "* Veuillez agr\u00e9er aux conditions d'utilisation du site", "validators", "fr");
})(Translator);
