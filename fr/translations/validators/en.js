...
t.add("property.name.not_blank", "* This field cannot be blank", "validators", "en");
t.add("property.name.length_min", "* This field must contain at least {{ limit }} characters", "validators", "en");
t.add("property.name.length_max", "* This field cannot exceed {{ limit }} characters", "validators", "en");
t.add("property.price.not_blank", "* This field cannot be blank", "validators", "en");
t.add("property.price.number", "* You must enter a number", "validators", "en");
t.add("property.price.positive", "* You must enter a number greater than 0", "validators", "en");
t.add("property.description.not_blank", "* This field cannot be blank", "validators", "en");
t.add("property.description.length_min", "* This field must contain at least {{ limit }} characters", "validators", "en");
t.add("property.description.length_max", "* This field cannot exceed {{ limit }} characters", "validators", "en");
t.add("property.city.not_blank", "* This field cannot be blank", "validators", "en");
t.add("property.city.length_min", "* This field must contain at least {{ limit }} characters", "validators", "en");
t.add("property.city.length_max", "* This field cannot exceed {{ limit }} characters", "validators", "en");
t.add("property.mapUrl.not_blank", "* This field cannot be blank", "validators", "en");
t.add("property.mapUrl.valid", "* Please enter a valid URL", "validators", "en");
t.add("property.roomsTotal.not_blank", "* This field cannot be blank", "validators", "en");
t.add("property.roomsTotal.number", "* You must enter a number", "validators", "en");
t.add("property.roomsTotal.positive", "* You must enter a number greater than 0", "validators", "en");
t.add("property.bedrooms.not_blank", "* This field cannot be blank", "validators", "en");
t.add("property.bedrooms.number", "* You must enter a number", "validators", "en");
t.add("property.bedrooms.positive", "* You must enter a number greater than 0", "validators", "en");
t.add("property.bathrooms.not_blank", "* This field cannot be blank", "validators", "en");
t.add("property.bathrooms.number", "* You must enter a number", "validators", "en");
t.add("property.bathrooms.positive", "* You must enter a number greater than 0", "validators", "en");
t.add("property.indoorSurface.not_blank", "* This field cannot be blank", "validators", "en");
t.add("property.indoorSurface.number", "* You must enter a number", "validators", "en");
t.add("property.indoorSurface.positive", "* You must enter a number greater than 0", "validators", "en");
t.add("property.outdoorSurface.not_blank", "* This field cannot be blank", "validators", "en");
t.add("property.outdoorSurface.number", "* You must enter a number", "validators", "en");
t.add("property.images.maxSizeMessage", "The photo cannot exceed {{ limit }} Mo", "validators", "en");
t.add("property.images.mimeTypesMessage", "Please choose a jpg, jpeg, png or webp format file", "validators", "en");
t.add("register.name.not_blank", "* This field cannot be blank", "validators", "en");
t.add("register.name.length_min", "* The name must have at least {{ limit }} characters", "validators", "en");
t.add("register.name.length_max", "* The name cannot exceed {{ limit }} characters", "validators", "en");
t.add("register.firstName.not_blank", "* This field cannot be blank", "validators", "en");
t.add("register.firstName.length_min", "* The first name must have at least {{ limit }} characters", "validators", "en");
t.add("register.firstName.length_max", "* The first name cannot exceed {{ limit }} characters", "validators", "en");
t.add("register.password.not_blank", "* This field cannot be blank", "validators", "en");
t.add("register.password.length_min", "* The password must have at least {{ limit }} characters", "validators", "en");
t.add("register.password.length_max", "* The password cannot exceed {{ limit }} characters", "validators", "en");
t.add("register.password.regex", "* The password must contain at least 1 uppercase letter, 1 lowercase letter and 1 special character", "validators", "en");
t.add("register.email.not_blank", "* This field cannot be blank", "validators", "en");
t.add("register.email.regex", "* The email address is not valid", "validators", "en");
t.add("register.email.unique", "* There is already an account with this email", "validators", "en");
t.add("register.conditions.isFalse", "* You must accept the terms of use", "validators", "en");
})(Translator);
